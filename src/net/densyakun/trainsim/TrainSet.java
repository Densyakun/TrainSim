...
public class TrainSet implements Serializable {
	...
	private MasterController mc;// マスコンの種類。マスコンの状態ではない。詳しくはTrainDriverクラスを参照。

	public TrainSet(String name, Car[] cars, int gauge, int maxspeed, double acceleration, double deceleration,
			MasterController mc) {
		this.name = name;
		this.cars = cars;
